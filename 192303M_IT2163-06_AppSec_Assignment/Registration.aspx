...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="text-center">
        <table class="center" style="width: 80%; height: 613px;">
            ...
            <tr>
                <td style="padding-bottom: 2.5%;" colspan="2">
                    <asp:Label ID="lbl_email0" runat="server" Text="Date of Birth" style="font-size: large;"></asp:Label>
                    <asp:TextBox ID="tb_dob" CssClass="userInput" runat="server" TextMode="Date"></asp:TextBox>
                    <br />
                    <b style="font-weight: normal">
            ...
            <asp:RequiredFieldValidator ID="lbl_cardholdererror" runat="server" ControlToValidate="tb_cardholdername" ErrorMessage="Please enter name of cardholder" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <td style="padding-bottom: 2.5%; width:50%;">
                    ...
                    <b style="font-weight: normal">
                    <asp:Label ID="lbl_cardtype" runat="server" Text="Name of Cardholder" style="font-size: large;"></asp:Label>
                    <br />
            ...
            <tr>
                <td colspan="2" style="padding-bottom: 2.5%;">
                    ...
                    <br />
                     <b style="font-weight: normal">
            <asp:RequiredFieldValidator ID="lbl_cardnoerror" runat="server" ControlToValidate="tb_cardno" ErrorMessage="Please enter the card number" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <tr>
                <td style="padding-bottom: 2.5%; width:50%;">
                    ...
                    <br />
                    <asp:TextBox ID="tb_expirydate" CssClass="userInput" TextMode="Date" runat="server"></asp:TextBox>
                    <br />

                    <b style="font-weight: normal">
            <asp:RequiredFieldValidator ID="lbl_expirydateerror" runat="server" ControlToValidate="tb_expirydate" ErrorMessage="Please enter expiry date" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <td style="padding-bottom: 2.5%; width:50%;">
                    ...
                    <b style="font-weight: normal">
            <asp:RequiredFieldValidator ID="lbl_cvverror" runat="server" ControlToValidate="tb_cvv" ErrorMessage="Please enter CVV" ForeColor="Red"></asp:RequiredFieldValidator>
